...
return (
    <div className="grid grid-cols-3 gap-7" > 
        ...
        <div className="relative col-span-1 bg-white shadow-lg rounded-xl p-2 "> 
            ...
            <div className="flex space-x-3 justify-center py-8">

            <img className = {programmingIcon} src={SwiftUI} alt="profile" ></img>
            <p className= " text-6xl text-blue-500 py-2">  <strong> + </strong>   </p>
            <img className = {programmingIcon} src={Xcode} alt="profile" ></img>
        ...
        <div className="relative col-span-1 bg-white shadow-lg rounded-xl p-2 "> 
            ...
            <p className = " text-md sm:text-md text-black text-left font-semibold pt-0.5 pl-3 absolute bottom-24 ">
                Connect with me: 
            </p>

            <div className=" flex align-center justify-center mt-2 absolute bottom-12">
            <a className="text-xl m-1 sm:m-2 sm:p-2 text-gray-800 hover:bg-gray-800 rounded-full 
            ...
            <a className="text-xl m-1 p-1 sm:m-2 sm:p-2  text-orange-500 hover:bg-orange-300 rounded-full 
